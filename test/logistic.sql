create tensor x(10000,4) from random((10000,4),(0,1))
create tensor y(10000,1) from zeros((10000,1))
...
create tensor test_x(1000,4) from random((1000,4),(0,1))
create tensor test_y(1000,1) from zeros((1000,1))
